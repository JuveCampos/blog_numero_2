---
title: "Guía de instalación: R, RStudio y librerías esenciales"
...
categories:
  ...
  - R
image: "señalando.png"
description: "Guía paso a paso para instalar R y RStudio en macOS y Windows, y dejar listas las librerías que usaremos durante el curso."
...
.tip-con-avatar .tip-contenido { flex: 1 1 auto; min-width: 0; }
.tip-con-avatar .tip-contenido > p:first-child { margin-top: 0; }
.tip-con-avatar .tip-contenido > p:last-child  { margin-bottom: 0; }
@media (max-width: 640px) {
  .tip-con-avatar { flex-direction: column; }
  .tip-con-avatar .avatar-tip { width: 60%; max-width: 220px; align-self: center; }
}
</style>
```
...
![](imagenes/c1.png){width="100%" fig-align="center"}
...
![](imagenes/c2.png){width="100%" fig-align="center"}
...
![](imagenes/c3.png){width="100%" fig-align="center"}
...
![](imagenes/c4.png){width="100%" fig-align="center"}
