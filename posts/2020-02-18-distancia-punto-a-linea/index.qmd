...
date: "2020-02-18"
categories: [Mapas, R, Tutoriales]
tags: [sf, geoespacial, frontera, shiny, distancias]
---
...
f <- st_read("../../data/BDs/shape Frontera/Mexico_and_US_Border.shp", quiet = TRUE)
```
